...
//function that parses/displays user topArtists data
var topArtists = (data) => {
  //clear page
  clearPage();
...
`;
  ...
  obscureArtists.map((artist) => {
    ...
    //bold first letter of artist name
  ...
  //if genre is undefined, go to next genre
  if (genre3 == undefined) {
    genre3 = data.items[3].genres[0];
  }
